...
public class TestReports extends TestSuiteBase
{
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if(! Test_Util.IsTestcaseRunMode(Payroll_2WeeklyCatC_SuiteXls, this.getClass().getSimpleName()))
		{
			...
			Test_Util.ReportDataSetResult(
					Payroll_2WeeklyCatC_SuiteXls, "first", Test_Util.GetRowNum(Payroll_2WeeklyCatC_SuiteXls, this.getClass().getSimpleName()),"Skipped");
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_2WeeklyCatC_SuiteXls,"TestReports");
	}
