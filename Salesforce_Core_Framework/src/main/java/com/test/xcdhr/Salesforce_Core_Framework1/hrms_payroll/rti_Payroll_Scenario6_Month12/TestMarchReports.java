...
public class TestMarchReports extends TestSuiteBase
{
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if(! Test_Util.IsTestcaseRunMode(Payroll_RecognitionScenarioSix_SuiteXls, this.getClass().getSimpleName()))
		{
			...
			Test_Util.ReportDataSetResult(
					Payroll_RecognitionScenarioSix_SuiteXls, "first", Test_Util.GetRowNum(Payroll_RecognitionScenarioSix_SuiteXls, this.getClass().getSimpleName()),"Skipped");
			...
			gotobreak:
				while(x.hasNext())
				{
					...
					else
					{
						...
						String addressLine3= table.getTBody().getRow(rownum).getCell(7).getText();
						...
						System.out.println("leavingDate is :"+PayrollId);

						String StDate= table.getTBody().getRow(rownum).getCell(12).getText();
						System.out.println("leavingDate is :"+StDate);

						String TwntyFourAStartDecln= table.getTBody().getRow(rownum).getCell(13).getText();
						System.out.println("leavingDate is :"+TwntyFourAStartDecln);
    
						String StudntLoanInd= table.getTBody().getRow(rownum).getCell(14).getText();
						System.out.println("leavingDate is :"+StudntLoanInd);
						...
						String StudntLoan = table.getTBody().getRow(rownum).getCell(17).getText();
						System.out.println("bacsHashcode is :"+StudntLoan);

						String PayFrequency= table.getTBody().getRow(rownum).getCell(18).getText();
						System.out.println("PayFrequency is :"+PayFrequency);

						String paymentDate = table.getTBody().getRow(rownum).getCell(19).getText();
						System.out.println("paymentDate is :"+paymentDate);

						String taxMonthNumber= table.getTBody().getRow(rownum).getCell(20).getText();
						System.out.println("taxMonthNumber is :"+taxMonthNumber);

						String numberOfEarningsperiodsCovered = table.getTBody().getRow(rownum).getCell(21).getText();
						System.out.println("numberOfEarningsperiodsCovered is :"+numberOfEarningsperiodsCovered);

						String numberOfNormalHoursWorked= table.getTBody().getRow(rownum).getCell(22).getText();
						System.out.println("numberOfNormalHoursWorked is :"+numberOfNormalHoursWorked);
						
						String taxCode= table.getTBody().getRow(rownum).getCell(23).getText();
						...
						String StudntLoanInPerod= table.getTBody().getRow(rownum).getCell(26).getText();
						System.out.println("payAfterStatutoryDeductions is :"+StudntLoanInPerod);
						
						
						String taxDeductedORrefunded = table.getTBody().getRow(rownum).getCell(27).getText();
						System.out.println("taxDeductedORrefunded is :"+taxDeductedORrefunded);
									
						String niCategory= table.getTBody().getRow(rownum).getCell(28).getText();
						System.out.println("niCategory is :"+niCategory);

						String grossEarningsNICsInPeriod = table.getTBody().getRow(rownum).getCell(29).getText();
						System.out.println("grossEarningsNICsInPeriod is :"+grossEarningsNICsInPeriod);

						String grossEarningsNICsInYTD= table.getTBody().getRow(rownum).getCell(30).getText();
						System.out.println("grossEarningsNICsInYTD is :"+grossEarningsNICsInYTD);

						String earningsAtLowerEarningslimitYTD = table.getTBody().getRow(rownum).getCell(31).getText();
						System.out.println("earningsAtLowerEarningslimitYTD is :"+earningsAtLowerEarningslimitYTD);

						String earningsLELUpToIncludingPTYTD= table.getTBody().getRow(rownum).getCell(32).getText();
						System.out.println("earningsLELUpToIncludingPTYTD is :"+earningsLELUpToIncludingPTYTD);
						
						String earningsPTIncludingUELYTD = table.getTBody().getRow(rownum).getCell(33).getText();
						System.out.println("earningsPTIncludingUELYTD is :"+earningsPTIncludingUELYTD);

						String totalOfEmployerContributions= table.getTBody().getRow(rownum).getCell(34).getText();
						System.out.println("totalOfEmployerContributions is :"+totalOfEmployerContributions);

						String totalOfEmployerContributionsYTD= table.getTBody().getRow(rownum).getCell(35).getText();
						System.out.println("totalOfEmployerContributionsYTD is :"+totalOfEmployerContributionsYTD);

						String employeeContributionsPayable= table.getTBody().getRow(rownum).getCell(36).getText();
						...
						ReadsExpectedData11a(EmpName,nationalInsurance,Title,Forename,Surname,addressLine1,addressLine2,addressLine3,ukPostcode,dateOfBirth,currentGender,PayrollId,StDate,TwntyFourAStartDecln,StudntLoanInd,taxablePay,totaltax,StudntLoan,PayFrequency,paymentDate,taxMonthNumber,numberOfEarningsperiodsCovered,numberOfNormalHoursWorked,taxCode,taxablePayInPeriod,payAfterStatutoryDeductions,StudntLoanInPerod,taxDeductedORrefunded,niCategory,grossEarningsNICsInPeriod,grossEarningsNICsInYTD,earningsAtLowerEarningslimitYTD,earningsLELUpToIncludingPTYTD,earningsPTIncludingUELYTD,totalOfEmployerContributions,totalOfEmployerContributionsYTD,employeeContributionsPayable,employeeContributionsPayableYTD,TestResultExcelFilePath,TestReportworksheetNo,ExpectedResultRowNumOfTestResultFile,ActualResultRowNumOfTestResultFile,TestRemarkRowNumOfTestResultFile);

						ReadsExpectedData11(EmpName,nationalInsurance,Title,Forename,Surname,addressLine1,addressLine2,addressLine3,ukPostcode,dateOfBirth,currentGender,PayrollId,StDate,TwntyFourAStartDecln,StudntLoanInd,taxablePay,totaltax,StudntLoan,PayFrequency,paymentDate,taxMonthNumber,numberOfEarningsperiodsCovered,numberOfNormalHoursWorked,taxCode,taxablePayInPeriod,payAfterStatutoryDeductions,StudntLoanInPerod,taxDeductedORrefunded,niCategory,grossEarningsNICsInPeriod,grossEarningsNICsInYTD,earningsAtLowerEarningslimitYTD,earningsLELUpToIncludingPTYTD,earningsPTIncludingUELYTD,totalOfEmployerContributions,totalOfEmployerContributionsYTD,employeeContributionsPayable,employeeContributionsPayableYTD,TestResultExcelFilePath,TestReportworksheetNo,ExpectedResultRowNumOfTestResultFile,ActualResultRowNumOfTestResultFile,TestRemarkRowNumOfTestResultFile);
					}
					rownum++;
				}
		}
	...
	public void ReadsExpectedData1(String EmpName,String nationalInsurance,String Title,String Forename,String Surname,String addressLine1,String addressLine2,String addressLine3,String ukPostcode,String dateOfBirth,String currentGender,String PayrollId,String StDate,String TwntyFourAStartDecln,String StudntLoanInd,String taxablePay,String totaltax,String StudntLoan,String PayFrequency,String paymentDate,String taxMonthNumber,String numberOfEarningsperiodsCovered,String numberOfNormalHoursWorke,String taxCode,String taxablePayInPeriod,String payAfterStatutoryDeductions,String StudntLoanInPerod,String taxDeductedORrefunded,String niCategory,String grossEarningsNICsInPeriod,String grossEarningsNICsInYTD,String earningsAtLowerEarningslimitYTD,String earningsLELUpToIncludingPTYTD,String earningsPTIncludingUELYTD,String totalOfEmployerContributions,String totalOfEmployerContributionsYTD,String employeeContributionsPayable,String employeeContributionsPayableYTD,String TestResultExcelFilePath,String TestReportworksheetNo,String ExpectedResultRowNumOfTestResultFile,String ActualResultRowNumOfTestResultFile,String TestRemarkRowNumOfTestResultFile) throws Throwable
	{
	...
	public void ReadsExpectedData11a(String EmpName,String nationalInsurance,String Title,String Forename,String Surname,String addressLine1,String addressLine2,String addressLine3,String ukPostcode,String dateOfBirth,String currentGender,String PayrollId,String StDate,String TwntyFourAStartDecln,String StudntLoanInd,String taxablePay,String totaltax,String StudntLoan,String PayFrequency,String paymentDate,String taxMonthNumber,String numberOfEarningsperiodsCovered,String numberOfNormalHoursWorke,String taxCode,String taxablePayInPeriod,String payAfterStatutoryDeductions,String StudntLoanInPerod,String taxDeductedORrefunded,String niCategory,String grossEarningsNICsInPeriod,String grossEarningsNICsInYTD,String earningsAtLowerEarningslimitYTD,String earningsLELUpToIncludingPTYTD,String earningsPTIncludingUELYTD,String totalOfEmployerContributions,String totalOfEmployerContributionsYTD,String employeeContributionsPayable,String employeeContributionsPayableYTD,String TestResultExcelFilePath,String TestReportworksheetNo,String ExpectedResultRowNumOfTestResultFile,String ActualResultRowNumOfTestResultFile,String TestRemarkRowNumOfTestResultFile) throws Throwable
	{
		...
		for(int i =actualRowIntValue; i< rowNum; i++) // getting the expected data from expected result data row
		{
			...
			if(value1 != null && value1.equalsIgnoreCase(firstCellOfBody))
			{
				...
				row.createCell(8).setCellValue(addressLine3);
				...
				row.createCell(18).setCellValue(StudntLoan);
				row.createCell(19).setCellValue(PayFrequency);
				row.createCell(20).setCellValue(paymentDate);
				row.createCell(21).setCellValue(taxMonthNumber);
				row.createCell(22).setCellValue(numberOfEarningsperiodsCovered);
				row.createCell(23).setCellValue(numberOfNormalHoursWorke);
				row.createCell(24).setCellValue(taxCode);
				row.createCell(25).setCellValue(taxablePayInPeriod);
				row.createCell(26).setCellValue(payAfterStatutoryDeductions);
				row.createCell(27).setCellValue(StudntLoanInPerod);
				row.createCell(28).setCellValue(taxDeductedORrefunded);
				row.createCell(29).setCellValue(niCategory);
				row.createCell(30).setCellValue(grossEarningsNICsInPeriod);
				row.createCell(31).setCellValue(grossEarningsNICsInYTD);
				row.createCell(32).setCellValue(earningsAtLowerEarningslimitYTD);
				row.createCell(33).setCellValue(earningsLELUpToIncludingPTYTD);
				row.createCell(34).setCellValue(earningsPTIncludingUELYTD);
				row.createCell(35).setCellValue(totalOfEmployerContributions);
				row.createCell(36).setCellValue(totalOfEmployerContributionsYTD);
				row.createCell(37).setCellValue(employeeContributionsPayable);
				row.createCell(38).setCellValue(employeeContributionsPayableYTD);
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_RecognitionScenarioSix_SuiteXls,"TestMarchReports");
	}
