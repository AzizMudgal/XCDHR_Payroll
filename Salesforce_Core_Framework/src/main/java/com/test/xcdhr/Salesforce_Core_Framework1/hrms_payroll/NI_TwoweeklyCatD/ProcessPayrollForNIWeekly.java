...
public class ProcessPayrollForNIWeekly extends TestSuiteBase
{
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if (!Test_Util.IsTestcaseRunMode(Payroll_2WeeklyCatD_SuiteXls, this
				.getClass().getSimpleName()))
		{
			Skip = true;
			Test_Util.ReportDataSetResult(Payroll_2WeeklyCatD_SuiteXls, "first",
					Test_Util.GetRowNum(Payroll_2WeeklyCatD_SuiteXls, this
							.getClass().getSimpleName()), "Skipped");
			// Test_Util.ReportDataSetResult(Payroll_2WeeklyCatD_SuiteXls,
		...
		runmodes = Test_Util.getDataSetRunmodes(Payroll_2WeeklyCatD_SuiteXls, this
				.getClass().getSimpleName());
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_2WeeklyCatD_SuiteXls,"ProcessPayrollForNIWeekly");
	}
	...
	public void ReportDataSetResult() throws Throwable
	{
		...
		if (Skip)
		{
			Test_Util.ReportDataSetResult(Payroll_2WeeklyCatD_SuiteXls, this
