...
public class ReviewAutoEnrolmentForAprilPayroll extends TestSuiteBase
{
	...
	public void reviewAutoEnrolmentButton()throws Throwable
	{
		try
		{
			...
			{
				Assert.assertEquals(getObject("autoEnrTextlocator").getText(), "Auto enrolment");
			...
			{
				System.out.println("The application displayed this message"+getObject("saveAndAcnValidnMessage").getText());
			}
