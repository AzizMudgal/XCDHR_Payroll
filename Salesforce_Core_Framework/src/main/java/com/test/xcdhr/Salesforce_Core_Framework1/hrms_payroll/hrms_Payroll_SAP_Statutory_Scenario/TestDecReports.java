...
public class TestDecReports extends TestSuiteBase
{
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if(! Test_Util.IsTestcaseRunMode(Payroll_Statutory_Adoption_SuiteXls, this.getClass().getSimpleName()))
		{
			...
			Test_Util.ReportDataSetResult(
					Payroll_Statutory_Adoption_SuiteXls, "first", Test_Util.GetRowNum(Payroll_Statutory_Adoption_SuiteXls, this.getClass().getSimpleName()),"Skipped");
			...
			while(x.hasNext())
			{
				...
				else
				{
					...
					String statutoryAdoptionPay= table.getTBody().getRow(rownum).getCell(1).getText();
					 ...
					 String NICstatutoryAdoptionPay= table.getTBody().getRow(rownum).getCell(3).getText();
					 System.out.println("NICstatutoryAdoptionPay is :"+NICstatutoryAdoptionPay);
					 String TaxablePay= table.getTBody().getRow(rownum).getCell(4).getText();
					 System.out.println("TaxablePay is :"+TaxablePay);
					//call the function which reads the excel sheet.
						ReadsExpectedData(EmpName,statutoryAdoptionPay,statutoryMaternityPay,NICstatutoryAdoptionPay,TaxablePay,TestResultExcelFilePath,TestReportworksheetNo);
	...
	public void ReadsExpectedData(String EmpName,String statutoryAdoptionPay,String statutoryMaternityPay,String NICstatutoryAdoptionPay,String TaxablePay,String TestResultExcelFilePath,String TestReportworksheetNo) throws Throwable
	{
		...
		for(int i =2; i< rowNum; i++)
		{
			...
			{
				row.createCell(11).setCellValue(statutoryAdoptionPay);
				row.createCell(12).setCellValue(statutoryMaternityPay);
				row.createCell(13).setCellValue(NICstatutoryAdoptionPay);
				row.createCell(14).setCellValue(TaxablePay);
				...
				if(value4 != null && value4.equalsIgnoreCase(NICstatutoryAdoptionPay))
				{
				...
				if(value5 != null && value5.equalsIgnoreCase(TaxablePay))
				{
	...
	public String cellToString(Cell cell)
{
	...
	public Object[][] getData() throws Throwable
	{
		...
		return Test_Util.getData(Payroll_Statutory_Adoption_SuiteXls,"ProcessPayrollForDecMonthSAP");
	}
