...
public class TestSuiteBase extends TestBase{
	...
	public void CheckSuiteSkip() throws Throwable {
		...
		initialize();
		APP_LOGS.debug("Checking runmode of "+Payroll_NI_Under21_SuiteXls_InputExcelFile);
		if(! Test_Util.isSuiteRunnable(SuiteXls, Payroll_NI_Under21_SuiteXls_InputExcelFile)){
