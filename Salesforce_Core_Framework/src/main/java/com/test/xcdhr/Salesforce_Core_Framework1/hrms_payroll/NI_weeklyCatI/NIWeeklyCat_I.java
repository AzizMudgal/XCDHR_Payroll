...
public class NIWeeklyCat_I extends TestSuiteBase {
	...
	public void CheckTestSkip() throws Throwable{
		...
		if(! Test_Util.IsTestcaseRunMode(Payroll_CatI_SuiteXls, this.getClass().getSimpleName())){
			...
			Skip=true;
			Test_Util.ReportDataSetResult(Payroll_CatI_SuiteXls, "first", Test_Util.GetRowNum(Payroll_CatI_SuiteXls, this.getClass().getSimpleName()),"Skipped");
	...
	public Object[][] getData() throws Throwable{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_CatI_SuiteXls,"NIWeeklyCat_I");
	}
