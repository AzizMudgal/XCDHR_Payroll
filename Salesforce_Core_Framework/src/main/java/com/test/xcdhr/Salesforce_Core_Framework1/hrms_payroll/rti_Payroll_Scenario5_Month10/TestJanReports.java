package com.test.xcdhr.Salesforce_Core_Framework1.hrms_payroll.rti_Payroll_Scenario5_Month10;
...
public class TestJanReports extends TestSuiteBase
{
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if(! Test_Util.IsTestcaseRunMode(Payroll_RecognitionScenarioFive_SuiteXls, this.getClass().getSimpleName()))
		{
			Skip=true;
			Test_Util.ReportDataSetResult(
					Payroll_RecognitionScenarioFive_SuiteXls, "first", Test_Util.GetRowNum(Payroll_RecognitionScenarioFive_SuiteXls, this.getClass().getSimpleName()),"Skipped");
			//Test_Util.ReportDataSetResult(Payroll_RecognitionScenarioFive_SuiteXls, this.getClass().getSimpleName(), count+2, "Skip");
			APP_LOGS.debug("skipping the testcase" +this.getClass().getSimpleName() +" as the runmode is set to 'no' ");// this message would display in logs
			throw new Exception("Testcase is being skipped" + this.getClass().getSimpleName()+ "as it's Runmode is set to 'NO'"); // this msg would display in Reports.
		}
		// Load the runmodes of the tests
		runmodes=Test_Util.getDataSetRunmodes(Payroll_RecognitionScenarioFive_SuiteXls, this.getClass().getSimpleName());
	}
			...
			gotobreak:
				while(x.hasNext())
				{
					...
					else
					{
						...
						String foreignCountry = table.getTBody().getRow(rownum).getCell(8).getText();
						System.out.println("ukPostcode is :"+foreignCountry);
						...
						String startDate= table.getTBody().getRow(rownum).getCell(12).getText();
						System.out.println("payrollIdChanged is :"+startDate);

						String startingDeclaration= table.getTBody().getRow(rownum).getCell(13).getText();
						System.out.println("oldPayrollId is :"+startingDeclaration);
						...
						String bacsHashcode = table.getTBody().getRow(rownum).getCell(17).getText();
						...
						ReadsExpectedData1(EmpName,nationalInsurance,Title,Forename,Surname,addressLine1,addressLine2,ukPostcode,foreignCountry,dateOfBirth,currentGender,payrollId,startDate,startingDeclaration,leavingDate,taxablePay,totaltax,bacsHashcode,PayFrequency,paymentDate,taxMonthNumber,numberOfEarningsperiodsCovered,numberOfNormalHoursWorked,taxCode,taxablePayInPeriod,payAfterStatutoryDeductions,taxDeductedORrefunded,niCategory,grossEarningsNICsInPeriod,grossEarningsNICsInYTD,earningsAtLowerEarningslimitYTD,earningsLELUpToIncludingPTYTD,earningsPTIncludingUELYTD,totalOfEmployerContributions,totalOfEmployerContributionsYTD,employeeContributionsPayable,employeeContributionsPayableYTD,TestResultExcelFilePath,TestReportworksheetNo,ExpectedResultRowNumOfTestResultFile,ActualResultRowNumOfTestResultFile,TestRemarkRowNumOfTestResultFile);

						ReadsExpectedData11a(EmpName,nationalInsurance,Title,Forename,Surname,addressLine1,addressLine2,ukPostcode,foreignCountry,dateOfBirth,currentGender,payrollId,startDate,startingDeclaration,leavingDate,taxablePay,totaltax,bacsHashcode,PayFrequency,paymentDate,taxMonthNumber,numberOfEarningsperiodsCovered,numberOfNormalHoursWorked,taxCode,taxablePayInPeriod,payAfterStatutoryDeductions,taxDeductedORrefunded,niCategory,grossEarningsNICsInPeriod,grossEarningsNICsInYTD,earningsAtLowerEarningslimitYTD,earningsLELUpToIncludingPTYTD,earningsPTIncludingUELYTD,totalOfEmployerContributions,totalOfEmployerContributionsYTD,employeeContributionsPayable,employeeContributionsPayableYTD,TestResultExcelFilePath,TestReportworksheetNo,ExpectedResultRowNumOfTestResultFile,ActualResultRowNumOfTestResultFile,TestRemarkRowNumOfTestResultFile);

						ReadsExpectedData11(EmpName,nationalInsurance,Title,Forename,Surname,addressLine1,addressLine2,ukPostcode,foreignCountry,dateOfBirth,currentGender,payrollId,startDate,startingDeclaration,leavingDate,taxablePay,totaltax,bacsHashcode,PayFrequency,paymentDate,taxMonthNumber,numberOfEarningsperiodsCovered,numberOfNormalHoursWorked,taxCode,taxablePayInPeriod,payAfterStatutoryDeductions,taxDeductedORrefunded,niCategory,grossEarningsNICsInPeriod,grossEarningsNICsInYTD,earningsAtLowerEarningslimitYTD,earningsLELUpToIncludingPTYTD,earningsPTIncludingUELYTD,totalOfEmployerContributions,totalOfEmployerContributionsYTD,employeeContributionsPayable,employeeContributionsPayableYTD,TestResultExcelFilePath,TestReportworksheetNo,ExpectedResultRowNumOfTestResultFile,ActualResultRowNumOfTestResultFile,TestRemarkRowNumOfTestResultFile);
					}
					rownum++;
				}
		}
	...
	public void ReadsExpectedData11a(String EmpName,String nationalInsurance,String Title,String Forename,String Surname,String addressLine1,String addressLine2,String ukPostcode,String foreignCountry,String dateOfBirth,String currentGender,String payrollId,String startDate,String startingDeclaration,String leavingDate,String taxablePay,String totaltax,String bacsHashcode,String PayFrequency,String paymentDate,String taxMonthNumber,String numberOfEarningsperiodsCovered,String numberOfNormalHoursWorked,String taxCode,String taxablePayInPeriod,String payAfterStatutoryDeductions,String taxDeductedORrefunded,String niCategory,String grossEarningsNICsInPeriod,String grossEarningsNICsInYTD,String earningsAtLowerEarningslimitYTD,String earningsLELUpToIncludingPTYTD,String earningsPTIncludingUELYTD,String totalOfEmployerContributions,String totalOfEmployerContributionsYTD,String employeeContributionsPayable,String employeeContributionsPayableYTD ,String TestResultExcelFilePath,String TestReportworksheetNo,String ExpectedResultRowNumOfTestResultFile,String ActualResultRowNumOfTestResultFile,String TestRemarkRowNumOfTestResultFile) throws Throwable
	{
		...
		for(int i =actualRowIntValue; i< rowNum; i++) // getting the expected data from expected result data row
		{
			...
			if(value1 != null && value1.equalsIgnoreCase(firstCellOfBody))
			{
				...
				row.createCell(9).setCellValue(foreignCountry);
				...
				row.createCell(13).setCellValue(startDate);
				row.createCell(14).setCellValue(startingDeclaration);
				...
				row.createCell(18).setCellValue(bacsHashcode);
				...
				row.createCell(23).setCellValue(numberOfNormalHoursWorked);
	...
	for(int j =testRmrkRowIntValue; j< rowNum; j++)
	{
		...
		if(value1 != null && value1.equalsIgnoreCase(firstCellOfBody))
		{
			...
			if(value9 != null && value9.equalsIgnoreCase(foreignCountry))
			{
			...
			if(value13 != null && value13.equalsIgnoreCase(startDate))
			{
			...
			if(value14 != null && value14.equalsIgnoreCase(startingDeclaration))
			{
			...
			if(value18 != null && value18.equalsIgnoreCase(bacsHashcode))
			{
			...
			if(value23 != null && value23.equalsIgnoreCase(numberOfNormalHoursWorked))
			{
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_RecognitionScenarioFive_SuiteXls,"TestJanReports");
	}
	...
	public void ReportDataSetResult() throws Throwable
	{
		...
		{
			IsTestPass = false;
			Test_Util.ReportDataSetResult(Payroll_RecognitionScenarioFive_SuiteXls, this.getClass().getSimpleName(), count+2, "Fail");
		}
		else
		{
			Test_Util.ReportDataSetResult(Payroll_RecognitionScenarioFive_SuiteXls, this.getClass().getSimpleName(), count+2, "Pass");
		}
		Skip=false;
		Fail=false;
	}
	...
	public void ReportTestResult() throws Throwable
	{
		...
		if(IsTestPass)
		{
			...
			Test_Util.ReportDataSetResult(Payroll_RecognitionScenarioFive_SuiteXls, "first", Test_Util.GetRowNum(Payroll_RecognitionScenarioFive_SuiteXls, this.getClass().getSimpleName()),"Pass");
		}
		else
		{
			Test_Util.ReportDataSetResult(Payroll_RecognitionScenarioFive_SuiteXls, "first", Test_Util.GetRowNum(Payroll_RecognitionScenarioFive_SuiteXls, this.getClass().getSimpleName()),"Fail");
		}
