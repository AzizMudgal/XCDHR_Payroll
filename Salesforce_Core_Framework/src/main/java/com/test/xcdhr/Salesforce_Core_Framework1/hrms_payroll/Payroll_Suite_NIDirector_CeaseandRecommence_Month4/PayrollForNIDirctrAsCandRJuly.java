...
public class PayrollForNIDirctrAsCandRJuly extends TestSuiteBase
{
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if (!Test_Util.IsTestcaseRunMode(Payroll_NI_CeaseandRecommence_SuiteXls, this
				.getClass().getSimpleName()))
		{
			Skip = true;
			Test_Util.ReportDataSetResult(Payroll_NI_CeaseandRecommence_SuiteXls, "first",
					Test_Util.GetRowNum(Payroll_NI_CeaseandRecommence_SuiteXls, this
							.getClass().getSimpleName()), "Skipped");
			// Test_Util.ReportDataSetResult(Payroll_NI_CeaseandRecommence_SuiteXls,
		...
		runmodes = Test_Util.getDataSetRunmodes(Payroll_NI_CeaseandRecommence_SuiteXls, this
				.getClass().getSimpleName());
	}
	...
	public void EmpsPayroll_Setup_ForIncomeTax(String EmployerName,String EmpName,String Payrolid,String Frquency,String MonthName,String ExcelInputSheet,String FirstReportNameInApplication,String TestResultExcelFilePath,String worksheetNo,String PayrollVeiw) throws Throwable
	{
		...
		if (finalRows != dTRows)
		{
			...
			PayrollForNIDirctrAsCandRJuly obj1 = new PayrollForNIDirctrAsCandRJuly();
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_NI_CeaseandRecommence_SuiteXls,"PayrollForNIDirctrAsCandRJuly");
	}
	...
	public void ReportDataSetResult() throws Throwable
	{
		...
		if (Skip)
		{
			Test_Util.ReportDataSetResult(Payroll_NI_CeaseandRecommence_SuiteXls, this
