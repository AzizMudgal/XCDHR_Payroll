...
public class ValidatePersonalTabFieldsForWeek1 extends TestSuiteBase {
	...
	public void CompareValidationReports(String EmployerName,String EmpName,String Payrolid,String Frquency,String WeekName,String ExcelInputSheet,String FirstReportNameInApplication,String TestResultExcelFilePath,String worksheetNo,String PayrollVeiw) throws Throwable
	{
		count++;
	...
	public void CreateCompenstionRecord(String EmpName,String TestResultExcelFilePath) throws Throwable
	{
		...
		try
		{
			...
			{
				System.out.println("The Appn did not displayed Attachement at all");
			...
			Thread.sleep(6000L);
				 ...
				 */
				ReadsExpectedData(EmpName,TestResultExcelFilePath,AutEnrolNotfnChkboxStatusValue,AutoEnrolNotifyAttahment);
	 ...
	 * 
	 */
	public void ReadsExpectedData(String EmpName,String TestResultExcelFilePath,String AutEnrolNotfnChkboxStatusValue,String AutoEnrolNotifyAttahment) throws Throwable
	{
		...
		row3.createCell(2).setCellValue(AutoEnrolNotifyAttahment);
		String Auto_enrolment_notification = cellToString(row3.getCell(2));
		row3.createCell(5).setCellValue(AutoEnrolNotifyAttahment);
		...
		if(employeeUnderTest != null && employeeUnderTest.equalsIgnoreCase(EmpName))
		{
			...
			if(Auto_enrolment_notification != (AutoEnrolNotifyAttahmentFalse) && Auto_enrolment_notification.equalsIgnoreCase(AutoEnrolNotifyAttahment))
			{
				 Cell cell1 = row3.createCell(6);
			...
			{
				 Cell cell1 = row3.createCell(6);
				row3.createCell(6).setCellValue("FALSE");
				cell1.setCellStyle(styleFalse);
			}
			/*
			 * add1 = expected value
