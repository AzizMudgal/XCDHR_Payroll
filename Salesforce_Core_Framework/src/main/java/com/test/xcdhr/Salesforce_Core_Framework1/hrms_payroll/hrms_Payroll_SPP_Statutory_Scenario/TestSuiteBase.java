...
public class TestSuiteBase extends TestBase
{
	...
	public void CheckSuiteSkip() throws Throwable
	{
		...
		initialize();
		APP_LOGS.debug("Checking runmode of"+ Statutory_StatutoryPaternityPay_InputExcelFile);
		if(! Test_Util.isSuiteRunnable(SuiteXls,Statutory_StatutoryPaternityPay_InputExcelFile))
		{
