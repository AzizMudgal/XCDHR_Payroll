package com.test.xcdhr.Salesforce_Core_Framework1.hrms_payroll.Payroll_Suite_NIDirector_Deferment_Month11;
...
public class NIDirector_ProrataMonth11 extends TestSuiteBase {
	...
	public void CheckTestSkip() throws Throwable{
		...
		if(! Test_Util.IsTestcaseRunMode(Payroll_NI_DirectorProrata_SuiteXls, this.getClass().getSimpleName())){
			...
			Skip=true;
			Test_Util.ReportDataSetResult(Payroll_NI_DirectorProrata_SuiteXls, "first", Test_Util.GetRowNum(Payroll_NI_DirectorProrata_SuiteXls, this.getClass().getSimpleName()),"Skipped");
	...
	public Object[][] getData() throws Throwable{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_NI_DirectorProrata_SuiteXls,"NIDirector_ProrataMonth11");
	}
