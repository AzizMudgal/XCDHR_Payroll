...
public class UpdteTaxCodeAndAnualSalaryM7 extends TestSuiteBase
{
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_RecognitionScenarioSeven_SuiteXls,"UpdteTaxCodeAndAnualSalaryM7");
	}
