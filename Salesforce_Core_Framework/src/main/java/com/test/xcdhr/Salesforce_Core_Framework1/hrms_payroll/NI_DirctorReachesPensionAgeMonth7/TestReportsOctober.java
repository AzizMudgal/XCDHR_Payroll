...
public class TestReportsOctober extends TestSuiteBase
{
	...
	public static String payrollMonth= "October-2015";
	public String ReportName= "DO NOT TOUCH - AUTOMN DIR REACHES PENSEN";
	...
	public void CompareReports() throws Throwable
	{
		...
		Thread.sleep(4000L);
		DownloadReports(pnReport,PayFrequency,payrollMonth);
	}
