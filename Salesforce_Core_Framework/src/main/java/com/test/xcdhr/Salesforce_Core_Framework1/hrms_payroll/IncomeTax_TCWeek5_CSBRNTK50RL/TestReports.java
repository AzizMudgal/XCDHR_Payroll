...
public class TestReports extends TestSuiteBase
{
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if(! Test_Util.IsTestcaseRunMode(TaxPayroll_TaxWeek5CSBRNTK50PercentRegulatory_SuiteXls, this.getClass().getSimpleName()))
		{
			...
			Test_Util.ReportDataSetResult(
					TaxPayroll_TaxWeek5CSBRNTK50PercentRegulatory_SuiteXls, "first", Test_Util.GetRowNum(TaxPayroll_TaxWeek5CSBRNTK50PercentRegulatory_SuiteXls, this.getClass().getSimpleName()),"Skipped");
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(TaxPayroll_TaxWeek5CSBRNTK50PercentRegulatory_SuiteXls,"TestReports");
	}
