...
public class ResetData extends TestSuiteBase
{
	...
	public void DeleteLeavefunctionDraft(String EmpName,String firstXCDpayDate,String payinStartPeriod) throws Throwable
	{
		...
		try
		{
			...
			/*
			 * need to check the parameter of org, like 
			 * if regress and automation org then run this method
			 * and if qa org then run this org.
			 * by this way we can avoid comment part as done below
			 */
			/*
	...
	public Object[][] getData() throws Throwable
	{
		...
		return Test_Util.getData(Payroll_Statutory_Paternitypay_Case2_SuiteXls,"ResetData");
	}
