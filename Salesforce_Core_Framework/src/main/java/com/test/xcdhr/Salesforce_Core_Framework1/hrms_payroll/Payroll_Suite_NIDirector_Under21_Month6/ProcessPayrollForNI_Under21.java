package com.test.xcdhr.Salesforce_Core_Framework1.hrms_payroll.Payroll_Suite_NIDirector_Under21_Month6;
...
public class ProcessPayrollForNI_Under21 extends TestSuiteBase
{
	...
	public int rownum;
	private String SeptemberMonth="September-2015";
	private String ExcelInputSheet="Payroll Suite NI Director Under21.xlsx";
	

	@BeforeTest
	public void CheckTestSkip() throws Exception
	{
		if (!Test_Util.IsTestcaseRunMode(Payroll_NI_Director_Under21_SuiteXls, this
				.getClass().getSimpleName()))
		{
			Skip = true;
			Test_Util.ReportDataSetResult(Payroll_NI_Director_Under21_SuiteXls, "first",
					Test_Util.GetRowNum(Payroll_NI_Director_Under21_SuiteXls, this
							.getClass().getSimpleName()), "Skipped");
			// Test_Util.ReportDataSetResult(Payroll_NI_Director_Under21_SuiteXls,
		...
		runmodes = Test_Util.getDataSetRunmodes(Payroll_NI_Director_Under21_SuiteXls, this
				.getClass().getSimpleName());
	...
	public void EmpsPayroll_Setup_ForIncomeTax(String EmpName) throws Throwable
	{
		...
		if (shouldOpenBrowser) {
			...
			try
			{
				...
				PayrollForMonthlyTax(SeptemberMonth);
	...
	public Object[][] getData()
	{
		...
		return Test_Util.getData(Payroll_NI_Director_Under21_SuiteXls,"ProcessPayrollForNI_Under21");
	}
	...
	public void ReportDataSetResult()
	{
		if (Skip)
		{
			Test_Util.ReportDataSetResult(Payroll_NI_Director_Under21_SuiteXls, this
