...
public class GeneralTaxRateMonthly extends TestSuiteBase {
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if(! Test_Util.IsTestcaseRunMode(TaxPayroll_TaxMonth9CSBRNTK50PercentRegulatory_SuiteXls, this.getClass().getSimpleName())){

			Skip=true;
			Test_Util.ReportDataSetResult(TaxPayroll_TaxMonth9CSBRNTK50PercentRegulatory_SuiteXls, "first", Test_Util.GetRowNum(TaxPayroll_TaxMonth9CSBRNTK50PercentRegulatory_SuiteXls, this.getClass().getSimpleName()),"Skipped");
			//Test_Util.ReportDataSetResult(TaxPayroll_TaxMonth9CSBRNTK50PercentRegulatory_SuiteXls, this.getClass().getSimpleName(), count+2, "Skip");
		...
		runmodes=Test_Util.getDataSetRunmodes(TaxPayroll_TaxMonth9CSBRNTK50PercentRegulatory_SuiteXls, this.getClass().getSimpleName());
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(TaxPayroll_TaxMonth9CSBRNTK50PercentRegulatory_SuiteXls,"GeneralTaxRateMonthly");
	}
	...
	public void ReportDataSetResult() throws Throwable
	{
		...
		if(Skip){
			...
			Test_Util.ReportDataSetResult(TaxPayroll_TaxMonth9CSBRNTK50PercentRegulatory_SuiteXls, this.getClass().getSimpleName(), count+2, "Fail");
		}else{
			Test_Util.ReportDataSetResult(TaxPayroll_TaxMonth9CSBRNTK50PercentRegulatory_SuiteXls, this.getClass().getSimpleName(), count+2, "Pass");
		}
	...
	public void ReportTestResult() throws Throwable
	{
		...
		if(IsTestPass)
		{
			...
			Test_Util.ReportDataSetResult(TaxPayroll_TaxMonth9CSBRNTK50PercentRegulatory_SuiteXls, "first", Test_Util.GetRowNum(TaxPayroll_TaxMonth9CSBRNTK50PercentRegulatory_SuiteXls, this.getClass().getSimpleName()),"Pass");

		}else{

			Test_Util.ReportDataSetResult(TaxPayroll_TaxMonth9CSBRNTK50PercentRegulatory_SuiteXls, "first", Test_Util.GetRowNum(TaxPayroll_TaxMonth9CSBRNTK50PercentRegulatory_SuiteXls, this.getClass().getSimpleName()),"Fail");
