...
public class UpdteTaxCodeAndAnualSalaryM1 extends TestSuiteBase
{
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_RecognitionScenarioSeven_SuiteXls,"UpdteTaxCodeAndAnualSalaryM1");
	}
