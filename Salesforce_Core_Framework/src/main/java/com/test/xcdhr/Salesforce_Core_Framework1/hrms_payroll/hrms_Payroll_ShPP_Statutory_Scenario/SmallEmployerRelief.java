...
public class SmallEmployerRelief extends TestSuiteBase
{
			...
			if(existsWebElement(postsTable))
			{
				...
				for(WebElement trElement : rows)
				{
					...
					for(WebElement tdElement : td_collection)
					{
						...
						if(tdElement.getText()!=null && tdElement.getText().equalsIgnoreCase("DONT TOUCH AUTO DIRSHPP COMPANY"))// DO NOT TOUCH AUTO ENROLMENT TEST COMPANY
						{	
							Thread.sleep(4000L);
			...
			if(existsWebElement(postsTable1))
			{
				...
				while(x1.hasNext())
				{
					...
					{							///table/tbody/tr[2]/td[2]/a
						...
						if(existsElementchkFor1mts(EmployerName))
						{
				...
				outerloop:
					for(WebElement trElement1 : rows11)
					{
						...
						for(WebElement tdElement : td_collection1)
						{
							...
							if(tdElement.getText()!=null && tdElement.getText().equalsIgnoreCase("DONT TOUCH AUTO DIRSHPP EMPLOYER"))
							{
								Thread.sleep(5000L);
					...
					for(WebElement trElement : rows)
					{
						...
						for(WebElement tdElement : td_collection)
						{
							...
							if(tdElement.getText()!=null && tdElement.getText().equalsIgnoreCase("Small employer relief"))
							{
								 ...
								 */
								WebElement clkchkbox = driver.findElement(By.xpath("//following-sibling::td[1]/input[@type='checkbox'][@tabindex='11']"));//[@tabindex='13']
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_Statutory_SharedParentalpay_SuiteXls,"SmallEmployerRelief");
	}
