...
public class TestReportsForWeek2Payroll extends TestSuiteBase
{
	...
	public void CompareReports(String EmployerName,String EmpName,String Payrolid,String Frquency,String WeekName,String ExcelInputSheet,String FirstReportNameInApplication,String TestResultExcelFilePath,String worksheetNo,String PayrollVeiw) throws Throwable
	{
		...
		Thread.sleep(4000L);
		DownloadReports(FirstReportNameInApplication,TestResultExcelFilePath,Payrolid,WeekName);
	}
	
	

	public void DownloadReports(String FirstReportNameInApplication,String TestResultExcelFilePath,String pn,String payrollMonth) throws Throwable
	{
		...
		{
			processReport(TestResultExcelFilePath);
	...
	public void processReport(String TestResultExcelFilePath)throws Throwable
	{
		try
		{
		if(existsElementchkFor1mts(OR.getProperty("reportTableLocatorNI")))
		...
		while(x.hasNext())
		{
			...
			{
				EmpName= table.getTBody().getRow(rownum).getCell(0).getText();
