...
public class ValidatePersonalTabFieldsForApril extends TestSuiteBase {
	...
	public void CheckTestSkip() throws Exception{
		if(! Test_Util.IsTestcaseRunMode(Payroll_AutoEnrolment_Employee_Join_SuiteXls, this.getClass().getSimpleName())){

			Skip=true;
			Test_Util.ReportDataSetResult(Payroll_AutoEnrolment_Employee_Join_SuiteXls, "first", Test_Util.GetRowNum(Payroll_AutoEnrolment_Employee_Join_SuiteXls, this.getClass().getSimpleName()),"Skipped");
			//Test_Util.ReportDataSetResult(Payroll_AutoEnrolment_Employee_Join_SuiteXls, this.getClass().getSimpleName(), count+2, "Skip");
			APP_LOGS.debug("skipping the testcase" +this.getClass().getSimpleName() +" as the runmode is set to 'no' ");// this message would display in logs
			throw new Exception("Testcase is being skipped" + this.getClass().getSimpleName()+ "as it's Runmode is set to 'NO'"); // this msg would display in Reports.
		}
		// Load the runmodes of the tests
		runmodes=Test_Util.getDataSetRunmodes(Payroll_AutoEnrolment_Employee_Join_SuiteXls, this.getClass().getSimpleName());
	}
	...
	public void CompareValidationReports(String EmployerName,String EmpName,String Payrolid,String Frquency,String MonthName,String ExcelInputSheet,String FirstReportNameInApplication,String TestResultExcelFilePath,String worksheetNo,String PayrollView) throws Throwable
	{
		count++;
	...
	public void ReadsExpectedData(String EmpName,String TestResultExcelFilePath,String AutEnrolNotfnChkboxStatusValue,String AutoEnrolNotifyAttahment) throws Throwable
	{
		...
		org.apache.poi.ss.usermodel.Sheet ws = wb.getSheetAt(9);
	...
	{
		return Test_Util.getData(Payroll_AutoEnrolment_Employee_Join_SuiteXls,"ProcessPayrollForApril");
	}
	...
	public void ReportDataSetResult()
	{
		...
		{
			IsTestPass = false;
			Test_Util.ReportDataSetResult(Payroll_AutoEnrolment_Employee_Join_SuiteXls, this.getClass().getSimpleName(), count+2, "Fail");
		}
		else
		{
			Test_Util.ReportDataSetResult(Payroll_AutoEnrolment_Employee_Join_SuiteXls, this.getClass().getSimpleName(), count+2, "Pass");
		}
	...
	public void ReportTestResult()
	{
		if(IsTestPass)
		{
			...
			Test_Util.ReportDataSetResult(Payroll_AutoEnrolment_Employee_Join_SuiteXls, "first", Test_Util.GetRowNum(Payroll_AutoEnrolment_Employee_Join_SuiteXls, this.getClass().getSimpleName()),"Pass");
		}
		else
		{
			Test_Util.ReportDataSetResult(Payroll_AutoEnrolment_Employee_Join_SuiteXls, "first", Test_Util.GetRowNum(Payroll_AutoEnrolment_Employee_Join_SuiteXls, this.getClass().getSimpleName()),"Fail");
		}	
		closeBrowser();
	}
