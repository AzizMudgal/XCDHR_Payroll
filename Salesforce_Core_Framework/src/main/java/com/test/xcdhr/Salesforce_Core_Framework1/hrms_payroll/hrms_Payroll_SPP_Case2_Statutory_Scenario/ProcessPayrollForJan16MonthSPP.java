...
public class ProcessPayrollForJan16MonthSPP extends TestSuiteBase
{
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if (!Test_Util.IsTestcaseRunMode(Payroll_Statutory_Paternitypay_Case2_SuiteXls, this
				.getClass().getSimpleName()))
		{
			Skip = true;
			Test_Util.ReportDataSetResult(Payroll_Statutory_Paternitypay_Case2_SuiteXls, "first",
					Test_Util.GetRowNum(Payroll_Statutory_Paternitypay_Case2_SuiteXls, this
							.getClass().getSimpleName()), "Skipped");
			// Test_Util.ReportDataSetResult(Payroll_Statutory_Paternitypay_Case2_SuiteXls,
		...
		runmodes = Test_Util.getDataSetRunmodes(Payroll_Statutory_Paternitypay_Case2_SuiteXls, this
				.getClass().getSimpleName());
	...
	public void EmpsPayroll_Setup_ForIncomeTax(String EmployerName,String EmpName,String Payrolid,String Frquency,String MonthName,String ExcelInputSheet,String FirstReportNameInApplication,String TestResultExcelFilePath,String worksheetNo,String PayrollVeiw,String TestReportworksheetNo) throws Throwable
	{
		...
		if (finalRows != dTRows)
		{
			...
			ProcessPayrollForJan16MonthSPP obj1 = new ProcessPayrollForJan16MonthSPP();
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_Statutory_Paternitypay_Case2_SuiteXls,"ProcessPayrollForJan16MonthSPP");
	}
	...
	public void ReportDataSetResult() throws Throwable
	{
		...
		if (Skip)
		{
			Test_Util.ReportDataSetResult(Payroll_Statutory_Paternitypay_Case2_SuiteXls, this
