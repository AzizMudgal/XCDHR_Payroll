package com.test.xcdhr.Salesforce_Core_Framework1.hrms_payroll.NI_TwoweeklyCatZ;
...
public class NI2WeeklyCat_Z extends TestSuiteBase {
	...
	public void CheckTestSkip() throws Throwable{
		...
		if(! Test_Util.IsTestcaseRunMode(Payroll_2WeeklyCatZ_SuiteXls, this.getClass().getSimpleName())){
			...
			Skip=true;
			Test_Util.ReportDataSetResult(Payroll_2WeeklyCatZ_SuiteXls, "first", Test_Util.GetRowNum(Payroll_2WeeklyCatZ_SuiteXls, this.getClass().getSimpleName()),"Skipped");
		...
		runmodes=Test_Util.getDataSetRunmodes(Payroll_2WeeklyCatZ_SuiteXls, this.getClass().getSimpleName());
	...
	public void ReportDataSetResult() throws Throwable{
		...
		if(Skip){
			...
			Test_Util.ReportDataSetResult(Payroll_2WeeklyCatZ_SuiteXls, this.getClass().getSimpleName(), count+2, "Fail");
		}else{
			Test_Util.ReportDataSetResult(Payroll_2WeeklyCatZ_SuiteXls, this.getClass().getSimpleName(), count+2, "Pass");
		}
	...
	public void ReportTestResult() throws Throwable
	{
		...
		if(IsTestPass)
		{
			...
			Test_Util.ReportDataSetResult(Payroll_2WeeklyCatZ_SuiteXls, "first", Test_Util.GetRowNum(Payroll_2WeeklyCatZ_SuiteXls, this.getClass().getSimpleName()),"Pass");
		}
		else
		{
			Test_Util.ReportDataSetResult(Payroll_2WeeklyCatZ_SuiteXls, "first", Test_Util.GetRowNum(Payroll_2WeeklyCatZ_SuiteXls, this.getClass().getSimpleName()),"Fail");
		}	
