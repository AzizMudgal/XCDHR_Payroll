...
public class TestSuiteBase extends TestBase
{
	...
	public void CheckSuiteSkip() throws Throwable
	{
		...
		initialize();
		APP_LOGS.debug("Checking runmode of"+ StatutoryPaternityPayCase2_InputExcelFile);
		if(! Test_Util.isSuiteRunnable(SuiteXls,StatutoryPaternityPayCase2_InputExcelFile))
		{
