...
public class NI4WeeklyCat_C extends TestSuiteBase {
	...
	public void CheckTestSkip() throws Throwable{
		...
		if(! Test_Util.IsTestcaseRunMode(Payroll_4WeeklyCatC_SuiteXls, this.getClass().getSimpleName())){
			...
			Skip=true;
			Test_Util.ReportDataSetResult(Payroll_4WeeklyCatC_SuiteXls, "first", Test_Util.GetRowNum(Payroll_4WeeklyCatC_SuiteXls, this.getClass().getSimpleName()),"Skipped");
	...
	public Object[][] getData() throws Throwable{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_4WeeklyCatC_SuiteXls,"NI4WeeklyCat_C");
	}
	...
	public void ReportDataSetResult() throws Throwable{
		...
		if(Skip){
			...
			Test_Util.ReportDataSetResult(Payroll_4WeeklyCatC_SuiteXls, this.getClass().getSimpleName(), count+2, "Fail");
		}else{
			Test_Util.ReportDataSetResult(Payroll_4WeeklyCatC_SuiteXls, this.getClass().getSimpleName(), count+2, "Pass");
		}
	...
	public void ReportTestResult() throws Throwable
	{
		...
		if(IsTestPass)
		{
			...
			Test_Util.ReportDataSetResult(Payroll_4WeeklyCatC_SuiteXls, "first", Test_Util.GetRowNum(Payroll_4WeeklyCatC_SuiteXls, this.getClass().getSimpleName()),"Pass");
		}
		else
		{
			Test_Util.ReportDataSetResult(Payroll_4WeeklyCatC_SuiteXls, "first", Test_Util.GetRowNum(Payroll_4WeeklyCatC_SuiteXls, this.getClass().getSimpleName()),"Fail");
		}	
