...
public class ReviewAutoEnrolmentForAprilPayroll extends TestSuiteBase
{
	...
	{
		if (!Test_Util.IsTestcaseRunMode(Payroll_AutoEnrolment_Employee_OptIn_SuiteXls, this
				.getClass().getSimpleName()))
		{
			Skip = true;
			Test_Util.ReportDataSetResult(Payroll_AutoEnrolment_Employee_OptIn_SuiteXls, "first",
					Test_Util.GetRowNum(Payroll_AutoEnrolment_Employee_OptIn_SuiteXls, this
							.getClass().getSimpleName()), "Skipped");
			// Test_Util.ReportDataSetResult(Payroll_AutoEnrolment_Employee_OptIn_SuiteXls,
		...
		runmodes = Test_Util.getDataSetRunmodes(Payroll_AutoEnrolment_Employee_OptIn_SuiteXls, this
				.getClass().getSimpleName());
	...
	public void ReportDataSetResult()
	{
		if (Skip)
		{
			Test_Util.ReportDataSetResult(Payroll_AutoEnrolment_Employee_OptIn_SuiteXls, this
