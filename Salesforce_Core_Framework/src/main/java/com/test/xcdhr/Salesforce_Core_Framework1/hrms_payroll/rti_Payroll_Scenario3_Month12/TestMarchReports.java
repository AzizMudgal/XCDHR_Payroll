package com.test.xcdhr.Salesforce_Core_Framework1.hrms_payroll.rti_Payroll_Scenario3_Month12;
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if(! Test_Util.IsTestcaseRunMode(Payroll_RecognitionScenarioThree_SuiteXls, this.getClass().getSimpleName()))
		{
			...
			Test_Util.ReportDataSetResult(
					Payroll_RecognitionScenarioThree_SuiteXls, "first", Test_Util.GetRowNum(Payroll_RecognitionScenarioThree_SuiteXls, this.getClass().getSimpleName()),"Skipped");
...
/* Added by Swamy*/
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_RecognitionScenarioThree_SuiteXls,"TestMarchReports");
	}
