...
public class TestReports extends TestSuiteBase
{
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if(! Test_Util.IsTestcaseRunMode(Payroll_CatB_SuiteXls, this.getClass().getSimpleName()))
		{
			...
			Test_Util.ReportDataSetResult(
					Payroll_CatB_SuiteXls, "first", Test_Util.GetRowNum(Payroll_CatB_SuiteXls, this.getClass().getSimpleName()),"Skipped");
	...
	public void ReadsExpectedData(String EmpName,String statutoryAdoptionPay,String statutoryMaternityPay,String TestResultExcelFilePath,String TestReportworksheetNo) throws Throwable
	{
		...
		for(int i =2; i< rowNum; i++)
		{
			...
			String value2 = cellToString(row.getCell(5));//7
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_CatB_SuiteXls,"TestReports");
	}
