...
public class ProcessPayrollForNIMonthly extends TestSuiteBase
{
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if (!Test_Util.IsTestcaseRunMode(Payroll_MonthlyCatZ_SuiteXls, this
				.getClass().getSimpleName()))
		{
			Skip = true;
			Test_Util.ReportDataSetResult(Payroll_MonthlyCatZ_SuiteXls, "first",
					Test_Util.GetRowNum(Payroll_MonthlyCatZ_SuiteXls, this
							.getClass().getSimpleName()), "Skipped");
			// Test_Util.ReportDataSetResult(Payroll_MonthlyCatZ_SuiteXls,
		...
		runmodes = Test_Util.getDataSetRunmodes(Payroll_MonthlyCatZ_SuiteXls, this
				.getClass().getSimpleName());
	}
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_MonthlyCatZ_SuiteXls,"ProcessPayrollForNIMonthly");
	}
	...
	public void ReportDataSetResult() throws Throwable
	{
		...
		if (Skip)
		{
			Test_Util.ReportDataSetResult(Payroll_MonthlyCatZ_SuiteXls, this
