...
public class ReviewAutoEnrolmentForApril2016Payroll extends TestSuiteBase
{
	...
	{
		if (!Test_Util.IsTestcaseRunMode(Payroll_AutoEnrolment_Employee_Turns22_SuiteXls, this
				.getClass().getSimpleName()))
		{
			Skip = true;
			Test_Util.ReportDataSetResult(Payroll_AutoEnrolment_Employee_Turns22_SuiteXls, "first",
					Test_Util.GetRowNum(Payroll_AutoEnrolment_Employee_Turns22_SuiteXls, this
							.getClass().getSimpleName()), "Skipped");
			// Test_Util.ReportDataSetResult(Payroll_AutoEnrolment_Employee_Turns22_SuiteXls,
		...
		runmodes = Test_Util.getDataSetRunmodes(Payroll_AutoEnrolment_Employee_Turns22_SuiteXls, this
				.getClass().getSimpleName());
	...
	public void reviewAutoEnrolForApril(String EmployerName,String EmpName,String Payrolid,String Frquency,String MonthName,String ExcelInputSheet,String FirstReportNameInApplication,String TestResultExcelFilePath,String worksheetNo,String PayrollVeiw) throws Throwable
	{
		...
		if (shouldOpenBrowser) {
			...
			try
			{
				...
				System.out.println("");
				PayrollForMonthlyTaxForAutoEnrolEmployer2(EmployerName,EmpName,Payrolid,Frquency,MonthName,ExcelInputSheet,FirstReportNameInApplication,TestResultExcelFilePath,PayrollVeiw);
	...
	public void ReportDataSetResult()
	{
		if (Skip)
		{
			Test_Util.ReportDataSetResult(Payroll_AutoEnrolment_Employee_Turns22_SuiteXls, this
