package com.test.xcdhr.Salesforce_Core_Framework1.hrms_payroll.NI_DirctorReachesPensionAgeMonth7;
...
public class PayrollForNIDirctrAsRandPOct extends TestSuiteBase
{
	...
	public int rownum;
	private String OctoberMonth="October-2015";
	private String ExcelInputSheet="Payroll Suite NI Director ReachesPensionAge.xlsx";
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if (!Test_Util.IsTestcaseRunMode(Payroll_NI_DirectorReachesFor_PensionAge_SuiteXls, this
				.getClass().getSimpleName()))
		{
			Skip = true;
			Test_Util.ReportDataSetResult(Payroll_NI_DirectorReachesFor_PensionAge_SuiteXls, "first",
					Test_Util.GetRowNum(Payroll_NI_DirectorReachesFor_PensionAge_SuiteXls, this
							.getClass().getSimpleName()), "Skipped");
			// Test_Util.ReportDataSetResult(Payroll_NI_DirectorReachesFor_PensionAge_SuiteXls,
		...
		runmodes = Test_Util.getDataSetRunmodes(Payroll_NI_DirectorReachesFor_PensionAge_SuiteXls, this
				.getClass().getSimpleName());
	}
	...
	public void EmpsPayroll_Setup_ForIncomeTax(String EmployerName,String EmpName,String Payrolid,String Frquency,String MonthName,String ExcelInputSheet,String FirstReportNameInApplication,String TestResultExcelFilePath,String worksheetNo,String PayrollVeiw) throws Throwable
	{
		...
		if (shouldOpenBrowser)
		{
			...
			try
			{
				...
				System.out.println("");
				PayrollForMonthlyTax(OctoberMonth);
			}
			catch (Throwable t)
			{
		...
		if (finalRows != dTRows)
		{
			...
			PayrollForNIDirctrAsRandPOct obj1 = new PayrollForNIDirctrAsRandPOct();
	...
	public Object[][] getData() throws Throwable
	{
		...
		return Test_Util.getData(Payroll_NI_DirectorReachesFor_PensionAge_SuiteXls,"PayrollForNIDirctrAsRandPOct");
	}
	...
	public void ReportDataSetResult() throws Throwable
	{
		...
		if (Skip)
		{
			Test_Util.ReportDataSetResult(Payroll_NI_DirectorReachesFor_PensionAge_SuiteXls, this
