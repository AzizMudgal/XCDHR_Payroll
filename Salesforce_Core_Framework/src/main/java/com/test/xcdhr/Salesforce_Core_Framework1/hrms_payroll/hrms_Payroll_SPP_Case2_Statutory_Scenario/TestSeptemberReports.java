...
public class TestSeptemberReports extends TestSuiteBase
{
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if(! Test_Util.IsTestcaseRunMode(Payroll_Statutory_Paternitypay_Case2_SuiteXls, this.getClass().getSimpleName()))
		{
			...
			Test_Util.ReportDataSetResult(
					Payroll_Statutory_Paternitypay_Case2_SuiteXls, "first", Test_Util.GetRowNum(Payroll_Statutory_Paternitypay_Case2_SuiteXls, this.getClass().getSimpleName()),"Skipped");
