...
public class TestReports extends TestSuiteBase
{
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if(! Test_Util.IsTestcaseRunMode(TaxPayroll_TaxMonth5CSBRNTK50PercentRegulatory_SuiteXls, this.getClass().getSimpleName()))
		{
			...
			Test_Util.ReportDataSetResult(
					TaxPayroll_TaxMonth5CSBRNTK50PercentRegulatory_SuiteXls, "first", Test_Util.GetRowNum(TaxPayroll_TaxMonth5CSBRNTK50PercentRegulatory_SuiteXls, this.getClass().getSimpleName()),"Skipped");
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(TaxPayroll_TaxMonth5CSBRNTK50PercentRegulatory_SuiteXls,"TestReports");
	}
