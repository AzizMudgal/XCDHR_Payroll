...
public class NIWeeklyCat_D extends TestSuiteBase {
	...
	public void CheckTestSkip() throws Throwable{
		...
		if(! Test_Util.IsTestcaseRunMode(Payroll_CatD_SuiteXls, this.getClass().getSimpleName())){

			Skip=true;
			Test_Util.ReportDataSetResult(Payroll_CatD_SuiteXls, "first", Test_Util.GetRowNum(Payroll_CatD_SuiteXls, this.getClass().getSimpleName()),"Skipped");
			//Test_Util.ReportDataSetResult(Payroll_CatD_SuiteXls, this.getClass().getSimpleName(), count+2, "Skip");
		...
		runmodes=Test_Util.getDataSetRunmodes(Payroll_CatD_SuiteXls, this.getClass().getSimpleName());
	...
	public Object[][] getData() throws Throwable{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_CatD_SuiteXls,"NIWeeklyCat_D");
	}
	...
	public void ReportDataSetResult() throws Throwable{
		...
		if(Skip){
			...
			Test_Util.ReportDataSetResult(Payroll_CatD_SuiteXls, this.getClass().getSimpleName(), count+2, "Fail");
		}else{
			Test_Util.ReportDataSetResult(Payroll_CatD_SuiteXls, this.getClass().getSimpleName(), count+2, "Pass");
		}
	...
	public void ReportTestResult() throws Throwable
	{
		...
		if(IsTestPass)
		{
			...
			Test_Util.ReportDataSetResult(Payroll_CatD_SuiteXls, "first", Test_Util.GetRowNum(Payroll_CatD_SuiteXls, this.getClass().getSimpleName()),"Pass");
		}
		else
		{
			Test_Util.ReportDataSetResult(Payroll_CatD_SuiteXls, "first", Test_Util.GetRowNum(Payroll_CatD_SuiteXls, this.getClass().getSimpleName()),"Fail");
		}	
