...
public class ProcessFinalPayrollForOct extends TestSuiteBase
{
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_RecognitionScenarioFour_SuiteXls,"ProcessFinalPayrollForOct");
	}
