...
public class ValidateCompensationRecords extends TestSuiteBase {
	...
	public void EmpsPayroll_Setup_ForIncomeTax(String EmployerName,String EmpName,String Payrolid,String Frquency,String MonthName,String ExcelInputSheet,String FirstReportNameInApplication,String TestResultExcelFilePath,String worksheetNo,String PayrollVeiw) throws Throwable
	{
		...
		CreateCompenstionRecord(EmpName,firstCellOfBody);
	...
	public void CreateCompenstionRecord(String EmpName,String firstCellOfBody ) throws Throwable
	{
		try
		{
		...
		try
		{
			if(existsElement(OR.getProperty("otherDetailsTableLocator")))
			{
				...
				WebTable dateEnrolTable = WebTable.getTable(Autodateenrol);
				AutoEnrolmntdate= dateEnrolTable.getTBody().getRow(2).getCell(0).getText();
	...
	public void ReadsExpectedData(String EmpName,String AutoEnrolmntdate,String AutEnrolNotfnChkboxStatusValue,String AutoEnrolNotifyAttahment,String effectTo,String Action,String EffctFrom,String pensionScheme,String employrPension,String empPension) throws Throwable
	{
		...
		String Auto_enrolment_date = cellToString(row2.getCell(2));
		...
		row2.createCell(5).setCellValue(AutoEnrolmntdate);
		row3.createCell(5).setCellValue(AutoEnrolmtNotifnChkbox);
