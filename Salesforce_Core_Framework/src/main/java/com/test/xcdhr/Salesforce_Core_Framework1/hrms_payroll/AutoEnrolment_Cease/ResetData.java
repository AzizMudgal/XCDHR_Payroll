...
public class ResetData extends TestSuiteBase {
	...
	public void ToUpdateCompnRecords(String EmpName,String notfnchkbox,String payrollfrequency,String Effctivefrom,String annualSalary,String empJobrole,String PensionScheme) throws Throwable
	{
		count++;
		...
		DeleteCompensation2Record(EmpName,notfnchkbox,payrollfrequency,Effctivefrom,annualSalary,empJobrole,PensionScheme);
	...
	public void DeleteCompensation2Record(String EmpName,String notfnchkbox,String payrollfrequency,String Effctivefrom,String annualSalary,String empJobrole,String PensionScheme) throws Throwable
	{
		try
		{
		...
		try
		{
			...
			{
				createCompnRecord(EmpName,payrollfrequency,Effctivefrom,annualSalary,empJobrole,PensionScheme);
							...
							if(existsElement(OR.getProperty("compensationTableLocator")))
							{
							    ...
							    if(rownumv == 0)
								{
									System.out.println("All the existing records got deleted,"
										+ "hence now the script creates 2 new records as per the requirment specification");
	...
	public boolean uncheckAEChkbox(boolean autoEnrolmtChkboxx)throws Throwable
	{
		...
		{
			Thread.sleep(2000L);
			System.out.println("The auto enrolment notification checkbox was allready checked");
		}
		else
		{
			getObject("autoEnrolmentNotfnChkbox").click();
			System.out.println("The auto enrolment notification checkbox is now checked, Hence our condition got satisfied");
		}
	...
	public void createCompnRecord(String EmpName,String payrollfrequency,String Effctivefrom,String annualSalary,String empJobrole,String PensionScheme)throws Throwable
	{
		try
		{
			if(existsElement(OR.getProperty("compensationButtoncomppage")))
			{
				...
				if(existsElement(OR.getProperty("pensionschemeLookup")))
				{
					getObject("pensionschemeLookup").sendKeys("");
					getObject("pensionschemeLookup").click();
					String mainHandle4 = driver.getWindowHandle(); // To save the parent window
					// create one more method for reading employee from excel sheet.
					ReadPensionScheme(PensionScheme);
					driver.switchTo().window(mainHandle4); // finally switch back to parent window and perform the operations.
					Thread.sleep(2000L);
		...
		driver.switchTo().window(handles[handles.length - 1]); 
				...
				if (driver.getTitle().equalsIgnoreCase(axb))
				{
					...
					System.out.println("title is matching");
						...
						Thread.sleep(3000);
						getObject("searchField").sendKeys(empJobrole);
	...
	public void ReadPensionScheme(String PensionScheme)throws Throwable
	{
					...
					System.out.println("title is matching");
						...
						*/
						...
						if(existsElement(OR.getProperty("showAllResults")))
						{
							...
							if(existsElement(OR.getProperty("pensionSchemeTableLocator")))
							{
								WebElement JobRoleTable = driver.findElement(By.xpath(OR.getProperty("pensionSchemeTableLocator")));

								List<WebElement> rows = JobRoleTable.findElements(By.xpath(OR.getProperty("pensionSchemeTablerowsLocator")));
								java.util.Iterator<WebElement> x = rows.iterator();
								int rownum = 2;			
								while(x.hasNext())
								{
									String PensionSchemeRecord="//div[contains(@class, 'brandSecondaryBrd ')]/div/table/tbody/"+"tr["+rownum+"]"+"/th/a";
											//"//*[@id='new']/div/div[2]/div[2]/div/div[2]/table/tbody/"+"tr["+rownum+"]"+"/td[1]";
									WebElement pensonSchmeClk= driver.findElement(By.xpath(PensionSchemeRecord));
									String scheme= pensonSchmeClk.getText();
									//System.out.println(tempEmp+"-------"+empName+"------"+rownum);
									if(scheme!=null && scheme.equalsIgnoreCase(PensionScheme))
									{
									
										System.out.println("pension scheme matched");
										System.out.println("pension scheme name is  :"+scheme);
										System.out.println("I clicked the user finally");
										Thread.sleep(2000);		
										pensonSchmeClk.click();
										break;
									}
									rownum++;
								}
	...
	{
		return Test_Util.getData(Payroll_AutoEnrolment_Employee_Cease_SuiteXls,"ResetData");
	}
