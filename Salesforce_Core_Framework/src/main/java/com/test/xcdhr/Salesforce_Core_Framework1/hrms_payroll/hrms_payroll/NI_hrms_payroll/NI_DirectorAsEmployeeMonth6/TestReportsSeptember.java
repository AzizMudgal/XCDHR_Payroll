package com.test.xcdhr.Salesforce_Core_Framework1.hrms_payroll.hrms_payroll.NI_hrms_payroll.NI_DirectorAsEmployeeMonth6;
...
public class TestReportsSeptember extends TestSuiteBase
{
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if(! Test_Util.IsTestcaseRunMode(Payroll_NI_DirectorAsEmployee_SuiteXls, this.getClass().getSimpleName()))
		{
			...
			Test_Util.ReportDataSetResult(
					Payroll_NI_DirectorAsEmployee_SuiteXls, "first", Test_Util.GetRowNum(Payroll_NI_DirectorAsEmployee_SuiteXls, this.getClass().getSimpleName()),"Skipped");
 ...
 */
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_NI_DirectorAsEmployee_SuiteXls,"TestReportsSeptember");
	}
