...
public class ValidatePersonalTabFieldsForApril extends TestSuiteBase {
	...
	public String SmallEmployerRelief;
	...
	public void validateAutoenrolmentForAprilMonth(String EmployerName,String EmpName,String Payrolid,String Frquency,String MonthName,String ExcelInputSheet,String FirstReportNameInApplication,String TestResultExcelFilePath,String worksheetNo,String PayrollVeiw) throws Throwable
	{
		count++;
		...
		personalTabValidation(EmpName,TestResultExcelFilePath);
	...
	public void personalTabValidation(String EmpName,String TestResultExcelFilePath ) throws Throwable
	{
		try
		{
		...
		try
		{
			if(existsElement(OR.getProperty("otherDetailsTableLocator")))
			{
				 ...
				 */
				ReadsExpectedData(EmpName,AutEnrolNotfnChkboxStatusValue,AutoEnrolNotifyAttahment,TestResultExcelFilePath);
	 ...
	 * 
	 */
	public void ReadsExpectedData(String EmpName,String AutEnrolNotfnChkboxStatusValue,String AutoEnrolNotifyAttahment,String TestResultExcelFilePath) throws Throwable
	{
	...
	{
		return Test_Util.getData(Payroll_AutoEnrolment_Employee_Turns22_SuiteXls,"ProcessPayrollForApril");
	}
