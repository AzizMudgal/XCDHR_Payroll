...
public class ResetData extends TestSuiteBase {
	...
	public void resetPersonalAndDeleteCompRecords(String EmpName,String notfnchkbox,String payrollfrequency,String Effctivefrom,String annualSalary,String EffectiveTo, String empJobrole) throws Throwable
	{
		count++;
		...
		DeleteCompensation2Record(EmpName,notfnchkbox,payrollfrequency,Effctivefrom,annualSalary,EffectiveTo,empJobrole);
	...
	public void compensationCreation(String EmpName,String notfnchkbox,String payrollfrequency,String Effctivefrom,String annualSalary,String EffectiveTo, String empJobrole) throws Throwable
	{
		countCompensation++;
		...
		{
			createCompnRecord(EmpName,payrollfrequency,Effctivefrom,annualSalary,EffectiveTo,empJobrole);
	...
	public void DeleteCompensation2Record(String EmpName,String notfnchkbox,String payrollfrequency,String Effctivefrom,String annualSalary,String EffectiveTo,String empJobrole) throws Throwable
	{
		try
		{
	...
	public boolean uncheckAEChkbox(boolean autoEnrolmtChkboxx)throws Throwable
	{
		...
		{
			System.out.println("Auto enrolment checkbox was allready unchecked, Hence our condition got satisfied");
	...
	public void createCompnRecord(String EmpName,String payrollfrequency,String Effctivefrom,String annualSalary,String EffectiveTo,String empJobrole)throws Throwable
	{
		try
		{
			if(existsElement(OR.getProperty("compensationButtoncomppage")))
			{
				...
				getObject("compensationButtoncomppage").click();
					...
					if(existsElement(OR.getProperty("compEffectiveToDate")))
					{
							getObject("compEffectiveToDate").sendKeys("");
							String dateStr = EffectiveTo;
							DateFormat readFormat = new SimpleDateFormat("MM/dd/yyyy");
							DateFormat writeFormat = new SimpleDateFormat("dd/MM/yyyy");
							Date date = null;				
							try 
							...
							System.out.println("The entered date is  " +formattedDate);		
							Thread.sleep(4000L);
							getObject("compEffectiveToDate").sendKeys(formattedDate);
	...
	{
		return Test_Util.getData(Payroll_AutoEnrolment_Employee_ChangeInEarnings_SuiteXls,"ResetData");
	}
