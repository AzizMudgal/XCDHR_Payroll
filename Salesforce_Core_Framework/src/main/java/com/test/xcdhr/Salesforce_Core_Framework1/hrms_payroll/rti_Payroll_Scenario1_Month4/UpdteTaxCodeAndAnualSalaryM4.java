package com.test.xcdhr.Salesforce_Core_Framework1.hrms_payroll.rti_Payroll_Scenario1_Month4;
...
public class UpdteTaxCodeAndAnualSalaryM4 extends TestSuiteBase
{
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_RecognitionScenarious_SuiteXls,"UpdteTaxCodeAndAnualSalaryM4");
	}
