...
public class TestSuiteBase extends TestBase{
	...
	public void CheckSuiteSkip() throws Throwable {
		...
		initialize();
		APP_LOGS.debug("Checking runmode of "+NI_Payroll_MonthlyCatM_SuiteXls_InputExcelFile);
		if(! Test_Util.isSuiteRunnable(SuiteXls, NI_Payroll_MonthlyCatM_SuiteXls_InputExcelFile)){
