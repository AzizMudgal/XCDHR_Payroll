...
public class UpdteTaxCodeAndAnualSalaryM10 extends TestSuiteBase
{
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		{
			Skip=true;
			Test_Util.ReportDataSetResult(Payroll_RecognitionScenarioSeven_SuiteXls, "first", Test_Util.GetRowNum(Payroll_RecognitionScenarioSeven_SuiteXls, this.getClass().getSimpleName()),"Skipped");
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_RecognitionScenarioSeven_SuiteXls,"UpdteTaxCodeAndAnualSalaryM10");
	}
