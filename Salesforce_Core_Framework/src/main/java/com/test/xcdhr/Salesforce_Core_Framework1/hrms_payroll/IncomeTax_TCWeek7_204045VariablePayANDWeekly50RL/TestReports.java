...
public class TestReports extends TestSuiteBase
{
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if(! Test_Util.IsTestcaseRunMode(Payroll_IncomeTax_TCWeek7_204045VariablePayANDWeekly50RL_SuiteXls, this.getClass().getSimpleName()))
		{
			Skip=true;
			Test_Util.ReportDataSetResult(
					Payroll_IncomeTax_TCWeek7_204045VariablePayANDWeekly50RL_SuiteXls, "first", Test_Util.GetRowNum(Payroll_IncomeTax_TCWeek7_204045VariablePayANDWeekly50RL_SuiteXls, this.getClass().getSimpleName()),"Skipped");
			//Test_Util.ReportDataSetResult(Payroll_IncomeTax_TCWeek7_204045VariablePayANDWeekly50RL_SuiteXls, this.getClass().getSimpleName(), count+2, "Skip");
			APP_LOGS.debug("skipping the testcase" +this.getClass().getSimpleName() +" as the runmode is set to 'no' ");// this message would display in logs
			throw new Exception("Testcase is being skipped" + this.getClass().getSimpleName()+ "as it's Runmode is set to 'NO'"); // this msg would display in Reports.
		}
		// Load the runmodes of the tests
		runmodes=Test_Util.getDataSetRunmodes(Payroll_IncomeTax_TCWeek7_204045VariablePayANDWeekly50RL_SuiteXls, this.getClass().getSimpleName());
	}
	...
	public void ReadsExpectedData(String EmpName,String statutoryAdoptionPay,String statutoryMaternityPay,String TestResultExcelFilePath) throws Throwable
	{
		...
		org.apache.poi.ss.usermodel.Sheet ws = wb.getSheetAt(16);
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_IncomeTax_TCWeek7_204045VariablePayANDWeekly50RL_SuiteXls,"TestReports");
	}
	...
	public void ReportDataSetResult() throws Throwable
	{
		...
		{
			IsTestPass = false;
			Test_Util.ReportDataSetResult(Payroll_IncomeTax_TCWeek7_204045VariablePayANDWeekly50RL_SuiteXls, this.getClass().getSimpleName(), count+2, "Fail");
		}
		else
		{
			Test_Util.ReportDataSetResult(Payroll_IncomeTax_TCWeek7_204045VariablePayANDWeekly50RL_SuiteXls, this.getClass().getSimpleName(), count+2, "Pass");
		}
		Skip=false;
		Fail=false;
	}
	...
	public void ReportTestResult() throws Throwable
	{
		...
		if(IsTestPass)
		{
			...
			Test_Util.ReportDataSetResult(Payroll_IncomeTax_TCWeek7_204045VariablePayANDWeekly50RL_SuiteXls, "first", Test_Util.GetRowNum(Payroll_IncomeTax_TCWeek7_204045VariablePayANDWeekly50RL_SuiteXls, this.getClass().getSimpleName()),"Pass");
		}
		else
		{
			Test_Util.ReportDataSetResult(Payroll_IncomeTax_TCWeek7_204045VariablePayANDWeekly50RL_SuiteXls, "first", Test_Util.GetRowNum(Payroll_IncomeTax_TCWeek7_204045VariablePayANDWeekly50RL_SuiteXls, this.getClass().getSimpleName()),"Fail");
		}
