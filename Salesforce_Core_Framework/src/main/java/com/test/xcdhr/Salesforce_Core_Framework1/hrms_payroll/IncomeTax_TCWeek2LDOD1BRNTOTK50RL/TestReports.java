...
public class TestReports extends TestSuiteBase
{
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if(! Test_Util.IsTestcaseRunMode(Payroll_GenerateTaxrateWeek2LDOD1BRNTOTK50percentRL_SuiteXls, this.getClass().getSimpleName()))
		{
			...
			Test_Util.ReportDataSetResult(
					Payroll_GenerateTaxrateWeek2LDOD1BRNTOTK50percentRL_SuiteXls, "first", Test_Util.GetRowNum(Payroll_GenerateTaxrateWeek2LDOD1BRNTOTK50percentRL_SuiteXls, this.getClass().getSimpleName()),"Skipped");
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_GenerateTaxrateWeek2LDOD1BRNTOTK50percentRL_SuiteXls,"TestReports");
	}
