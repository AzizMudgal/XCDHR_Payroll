...
public class ProcessPayrollForWeeklyTax extends TestSuiteBase
{
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if (!Test_Util.IsTestcaseRunMode(TaxPayroll_TaxWeek11CSBRNTK50PercentRegulatory_SuiteXls, this
				.getClass().getSimpleName()))
		{
			Skip = true;
			Test_Util.ReportDataSetResult(TaxPayroll_TaxWeek11CSBRNTK50PercentRegulatory_SuiteXls, "first",
					Test_Util.GetRowNum(TaxPayroll_TaxWeek11CSBRNTK50PercentRegulatory_SuiteXls, this
							.getClass().getSimpleName()), "Skipped");
			// Test_Util.ReportDataSetResult(TaxPayroll_TaxWeek11CSBRNTK50PercentRegulatory_SuiteXls,
		...
		runmodes = Test_Util.getDataSetRunmodes(TaxPayroll_TaxWeek11CSBRNTK50PercentRegulatory_SuiteXls, this
				.getClass().getSimpleName());
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(TaxPayroll_TaxWeek11CSBRNTK50PercentRegulatory_SuiteXls,"ProcessPayrollForWeeklyTax");
	}
	...
	public void ReportDataSetResult() throws Throwable
	{
		...
		if (Skip)
		{
			Test_Util.ReportDataSetResult(TaxPayroll_TaxWeek11CSBRNTK50PercentRegulatory_SuiteXls, this
