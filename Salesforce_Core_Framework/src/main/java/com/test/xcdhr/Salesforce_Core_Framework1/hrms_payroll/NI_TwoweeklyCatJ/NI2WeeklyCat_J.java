...
public class NI2WeeklyCat_J extends TestSuiteBase 
{
	...
	public void CheckTestSkip() throws Throwable{
		...
		if(! Test_Util.IsTestcaseRunMode(Payroll_2WeeklyCatJ_SuiteXls, this.getClass().getSimpleName())){
			...
			Skip=true;
			Test_Util.ReportDataSetResult(Payroll_2WeeklyCatJ_SuiteXls, "first", Test_Util.GetRowNum(Payroll_2WeeklyCatJ_SuiteXls, this.getClass().getSimpleName()),"Skipped");
	...
	public Object[][] getData() throws Throwable{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_2WeeklyCatJ_SuiteXls,"NI2WeeklyCat_J");
	}
