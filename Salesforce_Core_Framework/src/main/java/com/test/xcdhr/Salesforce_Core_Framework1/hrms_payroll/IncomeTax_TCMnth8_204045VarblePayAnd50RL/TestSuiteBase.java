...
public class TestSuiteBase extends TestBase
{
	...
	public void CheckSuiteSkip() throws Throwable
	{
		...
		initialize();
		APP_LOGS.debug("Checking runmode of  "+ IncomeTax_TCMonth8_204045VariablePayANDMonthly50RL_InputExcelFile);
		if(! Test_Util.isSuiteRunnable(SuiteXls,IncomeTax_TCMonth8_204045VariablePayANDMonthly50RL_InputExcelFile))
		{
