package com.test.xcdhr.Salesforce_Core_Framework1.hrms_payroll.rti_Payroll_Scenario1_Month5;
...
public class UpdteTaxCodeAndAnualSalaryM5 extends TestSuiteBase
{
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_RecognitionScenarious_SuiteXls,"UpdteTaxCodeAndAnualSalaryM5");
	}
