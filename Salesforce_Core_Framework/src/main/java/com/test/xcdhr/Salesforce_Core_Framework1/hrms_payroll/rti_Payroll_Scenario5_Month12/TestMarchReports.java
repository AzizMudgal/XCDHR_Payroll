package com.test.xcdhr.Salesforce_Core_Framework1.hrms_payroll.rti_Payroll_Scenario5_Month12;
...
public class TestMarchReports extends TestSuiteBase
{
			...
			gotobreak:
				while(x.hasNext())
				{
					...
					else
					{
						...
						System.out.println("foreignCountry is :"+foreignCountry);
						...
						String taxablePay = table.getTBody().getRow(rownum).getCell(14).getText();
						System.out.println("taxablePay is :"+taxablePay);

						String totaltax= table.getTBody().getRow(rownum).getCell(15).getText();
						System.out.println("totaltax is :"+totaltax);
												
						String bacsHashcode = table.getTBody().getRow(rownum).getCell(16).getText();
						System.out.println("bacsHashcode is :"+bacsHashcode);

						String PayFrequency= table.getTBody().getRow(rownum).getCell(17).getText();
						System.out.println("PayFrequency is :"+PayFrequency);

						String paymentDate = table.getTBody().getRow(rownum).getCell(18).getText();
						System.out.println("paymentDate is :"+paymentDate);

						String taxMonthNumber= table.getTBody().getRow(rownum).getCell(19).getText();
						System.out.println("taxMonthNumber is :"+taxMonthNumber);

						String numberOfEarningsperiodsCovered = table.getTBody().getRow(rownum).getCell(20).getText();
						...
						String week1Month1Indicator= table.getTBody().getRow(rownum).getCell(23).getText();
						System.out.println("taxCode is :"+week1Month1Indicator);
	...
	public void ReadsExpectedData11a(String EmpName,String nationalInsurance,String Title,String Forename,String Surname,String addressLine1,String addressLine2,String ukPostcode,String foreignCountry,String dateOfBirth,String currentGender,String payrollId,String startDate,String startingDeclaration,String taxablePay,String totaltax,String bacsHashcode,String PayFrequency,String paymentDate,String taxMonthNumber,String numberOfEarningsperiodsCovered,String numberOfNormalHoursWorked,String taxCode,String week1Month1Indicator,String taxablePayInPeriod,String payAfterStatutoryDeductions,String taxDeductedORrefunded,String niCategory,String grossEarningsNICsInPeriod,String grossEarningsNICsInYTD,String earningsAtLowerEarningslimitYTD,String earningsLELUpToIncludingPTYTD,String earningsPTIncludingUELYTD,String totalOfEmployerContributions,String totalOfEmployerContributionsYTD,String employeeContributionsPayable,String employeeContributionsPayableYTD ,String TestResultExcelFilePath,String TestReportworksheetNo,String ExpectedResultRowNumOfTestResultFile,String ActualResultRowNumOfTestResultFile,String TestRemarkRowNumOfTestResultFile) throws Throwable
	{
		...
		for(int i =actualRowIntValue; i< rowNum; i++) // getting the expected data from expected result data row
		{
			...
			if(value1 != null && value1.equalsIgnoreCase(firstCellOfBody))
			{
				...
				row.createCell(15).setCellValue(taxablePay);
				
				row.createCell(16).setCellValue(totaltax);
				row.createCell(17).setCellValue(bacsHashcode);

				row.createCell(18).setCellValue(PayFrequency);
				row.createCell(19).setCellValue(paymentDate);
				row.createCell(20).setCellValue(taxMonthNumber);
				...
				row.createCell(24).setCellValue(week1Month1Indicator);
	...
	for(int j =testRmrkRowIntValue; j< rowNum; j++)
	{
		...
		if(value1 != null && value1.equalsIgnoreCase(firstCellOfBody))
		{
			...
			if(value15 != null && value15.equalsIgnoreCase(taxablePay))
			{
			...
			if(value16 != null && value16.equalsIgnoreCase(totaltax))
			{
			...
			if(value17 != null && value17.equalsIgnoreCase(bacsHashcode))
			{
			...
			if(value18 != null && value18.equalsIgnoreCase(PayFrequency))
			{
			...
			if(value19 != null && value19.equalsIgnoreCase(paymentDate))
			{
			...
			if(value20 != null && value20.equalsIgnoreCase(taxMonthNumber))
			{
			...
			if(value21 != null && value21.equalsIgnoreCase(numberOfEarningsperiodsCovered))
			{
			...
			if(value22 != null && value22.equalsIgnoreCase(numberOfNormalHoursWorked))
			{
			...
			if(value23 != null && value23.equalsIgnoreCase(taxCode))
			{
			...
			if(value24 != null && value24.equalsIgnoreCase(week1Month1Indicator))
			{
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_RecognitionScenarioFive_SuiteXls,"TestMarchReports");
	}
