package com.test.xcdhr.Salesforce_Core_Framework1.hrms_payroll.rti_Payroll_Scenario3_Month9;
...
public class UpdteTaxCodeAndAnualSalaryM9 extends TestSuiteBase
{
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_RecognitionScenarioThree_SuiteXls,"UpdteTaxCodeAndAnualSalaryM9");
	}
