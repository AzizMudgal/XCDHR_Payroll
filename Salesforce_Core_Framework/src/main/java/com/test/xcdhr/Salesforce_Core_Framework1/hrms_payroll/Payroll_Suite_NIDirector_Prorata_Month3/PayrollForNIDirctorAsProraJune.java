package com.test.xcdhr.Salesforce_Core_Framework1.hrms_payroll.Payroll_Suite_NIDirector_Prorata_Month3;


import com.test.xcdhr.Salesforce_Core_Framework1.hrms_payroll.Payroll_Suite_NIDirector_Under21_Month1.ProcessPayrollForNI_Under211;
...
public class PayrollForNIDirctorAsProraJune extends TestSuiteBase
{
	...
	public void CheckTestSkip() throws Throwable
	{
		...
		if (!Test_Util.IsTestcaseRunMode(Payroll_NI_DirectorProrata_SuiteXls, this
				.getClass().getSimpleName()))
		{
			Skip = true;
			Test_Util.ReportDataSetResult(Payroll_NI_DirectorProrata_SuiteXls, "first",
					Test_Util.GetRowNum(Payroll_NI_DirectorProrata_SuiteXls, this
							.getClass().getSimpleName()), "Skipped");
			// Test_Util.ReportDataSetResult(Payroll_NI_DirectorProrata_SuiteXls,
		...
		runmodes = Test_Util.getDataSetRunmodes(Payroll_NI_DirectorProrata_SuiteXls, this
				.getClass().getSimpleName());
	}
	...
	public void EmpsPayroll_Setup_ForIncomeTax(String EmployerName,String EmpName,String Payrolid,String Frquency,String MonthName,String ExcelInputSheet,String FirstReportNameInApplication,String TestResultExcelFilePath,String worksheetNo,String PayrollVeiw) throws Throwable
	{
		...
		if (totalRows != draftTotalRows)
		{
			...
			ProcessPayrollForNI_Under211 obj1 = new ProcessPayrollForNI_Under211();
	...
	{
		processDesiredTaxYearInputExcelFile(TaxYear);
		return Test_Util.getData(Payroll_NI_DirectorProrata_SuiteXls,"PayrollForNIDirctorAsProraJune");
	}
	...
	public void ReportDataSetResult() throws Throwable
	{
		...
		if (Skip)
		{
			Test_Util.ReportDataSetResult(Payroll_NI_DirectorProrata_SuiteXls, this
